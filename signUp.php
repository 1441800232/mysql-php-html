...
$money = isset($_POST['money']) ? $_POST['money']: '';//获取充值金额
if (isset($_POST['submit'])) //当用户点击提交时
{
	$sql = "INSERT INTO user_copy1(account,email,password,username,money) VALUES('$account','$email','$password2','$ming','$money');"; //SQL语句
	if (mysqli_query($conn, $sql)) {
		echo "<script>alert('注册成功');window.location= 'management1.php';</script>";
	} else {
...
<body>
	...
	<div class="kuang">
		<div class="head">
			<span class="headone">匠心优品会员注册</span>
		</div>
