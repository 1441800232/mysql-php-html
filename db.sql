...
CREATE TABLE `user`  (
  `account` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL COMMENT '用户昵称',
  ...
  `ming`varchar(64) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL COMMENT '用户姓名',
